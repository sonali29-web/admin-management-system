...
<div className='flex flex-col gap-6 p-4'>
  ...
  <p className='text-stone-50 text-sm flex-wrap'>Login to your account and your dashboard efficiently</p>
  </div>
...
<div className='flex flex-col gap-1 p-1 '>
  ...
  <p className='text-[15px] mb-4 dark:text-zinc-100'>Enter Your Information to access your account</p>
</div>
<form className='flex flex-col p-4 gap-4' onSubmit={handleLoginsubmit}>
  <div className='flex flex-col gap-1'>
    ...
    <input  value={email} onChange={handleEmail} autoComplete='email' required className='border border-gray-300 w-full p-2 rounded-xl outline-none dark:bg-zinc-800 dark:text-zinc-600' type="email" placeholder='Email' />
  </div>

  <div className='flex flex-col gap-1'>
    <label htmlFor="" className='dark:text-zinc-100'>Password</label>
    <input value={password} onChange={handlePassword} autoComplete='current-password'   required className='border border-gray-300 w-full p-2 rounded-xl outline-none dark:bg-zinc-800 dark:text-zinc-600' type="password" placeholder='password'/>
  </div>
 ...
 Remember me</label>
 <button className=' text-white font-bold  bg-linear-to-r from-pink-500 to-pink-700 rounded-lg p-2 shadow-md hover:scale-105 transition '>Login</button>
  ...
  <p className='text-[13px] dark:text-zinc-100'>Dont have an account ? <Link  to={"/"} className='text-pink-600 text-center'>Signup</Link></p>
 </form>
 </div>
